...
public class updateItem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null){
            Glide.with(updateItem.this).load(bundle.getString("Image")).into(updateImage);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Bike Category").child(key);
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                saveData();
                Intent intent = new Intent(updateItem.this, rentBike.class);
                startActivity(intent);
            }
        });
    }
    public void saveData(){
        storageReference = FirebaseStorage.getInstance().getReference().child("Bike Category").child(uri.getLastPathSegment());
    ...
    public void updateData(){
        ...
        databaseReference.setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(updateItem.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}