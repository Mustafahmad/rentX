...
public class uploadItem extends AppCompatActivity {
    ...
    Button saveButton;
    EditText uploadTitle, uploadPrice, uploadArea,uploadNumber;
    String imageURL;
    Uri uri;
    @Override
                ...
                new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode()== Activity.RESULT_OK){
                            ...
                            Toast.makeText(uploadItem.this,"No Image Selected", Toast.LENGTH_SHORT).show();
                        }
                }
        }
        );
    ...
    private void saveData() {
        StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("Bike Category").child(uri.getLastPathSegment());
    ...
    public void uploadData(){
        ...
        FirebaseDatabase.getInstance().getReference("Bike Category").child(currentDate)
