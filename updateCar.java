...
public class updateCar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null){
            Glide.with(updateCar.this).load(bundle.getString("Image")).into(updateImage);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Cars Category").child(key);
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                saveData();
                Intent intent = new Intent(updateCar.this, rentCar.class);
                startActivity(intent);
            }
        });
    }
    public void saveData(){
        storageReference = FirebaseStorage.getInstance().getReference().child("Cars Category").child(uri.getLastPathSegment());
    ...
    public void updateData(){
        ...
        databaseReference.setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(updateCar.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}